<x-app-layout>
 ...
 <div class="container-fluid mt-5 bg-white p-5">
    ...
    <div class="row">
        ...
        <div class="col-md-9 mt-0">
        <h3 class="text-center" style="font-size:30px;">Add Gallary Form</h3>
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6 form-group mt-3">
                        <input type="submit" name="addgallary" value="Add Image" class="btn btn-md btn-primary bg-primary w-100">
                    </div>
