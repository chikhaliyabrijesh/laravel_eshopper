                ...
                <div class="w-100" style="overflow:auto">
                    <table class="table table-hover" id="tab">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href='{{URL("/manageblogs/".$row->id)}}' onclick="return confirm('Are You Sure To Delete Blog ?')"><i class="bi bi-trash3-fill text-danger"></i></a> |

                                <a href='{{URL("/editblogs/".$row->id)}}' onclick="return confirm('Are You Sure To Edit Blog  ?')"><i class="bi bi-pencil-fill text-primary"></i></a>
                            </td>
                        </tr>
                        @endforeach
                        </tbody>
