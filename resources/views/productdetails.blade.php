    ...
    <div class="container-fluid py-5">
        <div class="row px-xl-5">
            ...
            @endif
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        ...
                        <img class="img-fluid" src="{{asset('uploads/products/'.$rd->productimage)}}" alt="" style="width:100%; height:550px;">
                        </div>
            ...
            <div class="col-lg-7 pb-5">
                <h3 class="font-weight-semi-bold"><b><input type="text" name="description" value="{{$rd->description}}" style="border:none;"></b></h3>
