...
@section('content')
    ...
    <div class="container-fluid pt-5">
        <div class="row px-xl-5">
            ...
            <input type="hidden" value="{{ $row->newprice }}" class="total_input" name="total_input{{ $row->id }}">
            ...
            <div class="card border-secondary mb-5">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between mb-3 pt-1">
                        ...
                        <h6 class="font-weight-medium show_subtotal_label">${{ number_format($data->sum('newprice'), 2) }}
                        </h6>
                    </div>
                ...
                <div class="card-footer border-secondary bg-transparent">
                    <div class="d-flex justify-content-between mt-2">
                        ...
                        <h5 class="font-weight-bold show_total_label">
                            ${{ number_format($data->sum('newprice') + 10, 2) }}</h5>
                    </div>
